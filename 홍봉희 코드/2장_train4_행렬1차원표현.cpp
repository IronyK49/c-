...
void getMatrix(int *data, int rows, int cols); //type casting 
int* addMatrix(int*a, int*d, int rows, int cols);
...
int main() {
    ...
    int* result3 = multiplyMatrix((int*)a, AROWS, ACOLS, (int*)b, BROWS, BCOLS); // a[0][0]*b[0][0] + a[0][1](=a+1)*b[1][0](=b+b*cols+)
    printf("Matrix C = (A * B):\n");
